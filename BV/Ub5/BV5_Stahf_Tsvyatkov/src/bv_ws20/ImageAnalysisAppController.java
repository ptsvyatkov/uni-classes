...
public class ImageAnalysisAppController {
    ...
    void toggleAutoContrast() {
    	...
    	if(autoContrast) {
    		double autoContrast = -128 / (histogram.getLower() + histogram.getBrightnessOffset() - 128);
    		
    		brightnessSlider.setValue(histogram.getBrightnessOffset());
    		brightnessChanged();
    		contrastSlider.setValue(autoContrast);
    		contrastChanged();
    	} else {
    		brightnessSlider.setValue(0);
    		brightnessChanged();
